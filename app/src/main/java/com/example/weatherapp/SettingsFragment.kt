    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.buttonSaveSettings.setOnClickListener {
            ...
            if (city.isNotEmpty()) {
                ...
                Toast.makeText(requireContext(), R.string.city_saved, Toast.LENGTH_SHORT).show() // Use string resource
            } else {
                Toast.makeText(requireContext(), R.string.enter_city, Toast.LENGTH_SHORT).show() // Use string resource
            }
        }
